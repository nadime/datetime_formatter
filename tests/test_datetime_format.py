...
def test_formatter_input():
    ...
    assert DateTimeFormatter("2005-03-01 08:31:25").dt.dt == datetime(
        2005, 3, 1, 8, 31, 25
    )
    assert DateTimeFormatter("2005-03-01T05:00:00-00:00").dt.dt == datetime(
        2005, 3, 1, 5, 0, 0, tzinfo=timezone.utc
    )
...
def test_formatter_with_time_translation():
    ...
    assert (
        dtf.format("%YYYYMMDD-P889000Z% %HHMMSSZZ-P889000Z%")
